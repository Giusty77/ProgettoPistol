...
void ASWeaponSpell::BeginPlay()
{
	...
	SpellCollisionComponent->OnComponentBeginOverlap.AddDynamic(this, &ASWeaponSpell::OnBeginOverlap);
	SpellCollisionComponent->OnComponentHit.AddDynamic(this, &ASWeaponSpell::OnHit);
}

void ASWeaponSpell::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
void ASWeaponSpell::OnBeginOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
...
void ASWeaponSpell::OnHit(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
	SpellEnded(Hit.ImpactPoint);
}

void ASWeaponSpell::SpellEnded(FVector Location)
{
